...
<body id="body" class="container-center">
	...
	<div class="pub_msg">
		...
		<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
			<div>
				<input type="text" name="ed_message" class="ed_msg" placeholder="Write Something in this Field" autocomplete="off">
				<input type="submit" name="try" id="try1" value="POST" class="btn-success">
			</div>
...
<tbody>
						<tr>
							<?php while ($ret = mysqli_fetch_assoc($query2)):?>
								<td><a href="chat.php?id=<?php echo $fetch["userID"];?>"><?php echo $collect["post"];?></td></a>-->
						</tr>
							<?php endwhile; ?>
					</tbody>