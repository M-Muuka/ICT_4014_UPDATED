...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-md-offset-3 post" id="posted">
			<h2><?php 
				if (isset($_GET["id"])) {
					$post_id = $_GET["id"];

					$choose = "SELECT * FROM posts WHERE id = '$post_id'";
					$querie = mysqli_query($connect, $choose);
					$kept = mysqli_fetch_assoc($querie);
				}
					echo $kept['post'];
				?>	
			</h2>
		...
		<div class="col-md-6 col-md-offset-3 comments-section" id="chat">
